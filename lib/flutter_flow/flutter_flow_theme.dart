...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFF6F42C1);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFFCA2D);
  late Color tertiary = const Color(0xFF218838);
  late Color alternate = const Color(0xFF5A3E9A);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFCED4DA);
  late Color primaryBackground = const Color(0xFF343A40);
  late Color secondaryBackground = const Color(0xFF495057);
  late Color accent1 = const Color(0xFF138496);
  late Color accent2 = const Color(0xFFC82333);
  late Color accent3 = const Color(0xFFE63946);
